...
public class MethodObject implements AbstractMethodDeclaration {
    ...
    public MethodObject(MethodDeclaration methodDeclaration) {
    	this.constructorObject = new ConstructorObject(methodDeclaration);
    	/*List<IExtendedModifier> extendedModifiers = methodDeclaration.modifiers();
		for(IExtendedModifier extendedModifier : extendedModifiers) {
			if(extendedModifier.isAnnotation()) {
				Annotation annotation = (Annotation)extendedModifier;
				if(annotation.getTypeName().getFullyQualifiedName().equals("Test")) {
					this.setTestAnnotation(true);
					break;
				}
			}
		}*/
    ...
    public Set<FieldObject> getAccessedFields() {
    	return constructorObject.getAccessedFields();
    }
